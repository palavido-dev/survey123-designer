...
export const questionCategories: QuestionCategory[] = [
  {
    ...
    items: [
      ...
      { id: 'begin_group-grid3', type: 'begin_group', label: 'Grid 3-Col', icon: 'FolderOpen', defaultAppearance: 'w3', description: 'Grid group where children default to 3/4 width columns' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'select_one-horizontal-compact', type: 'select_one', label: 'Horizontal Compact', icon: 'CircleDot', defaultAppearance: 'horizontal-compact', description: 'Same as compact for single choice questions' },
      { id: 'select_one-yesno', type: 'select_one', label: 'Yes/No Toggle', icon: 'CircleDot', defaultAppearance: 'yes_no_toggle', description: 'Toggle switch for yes/no binary choices' },
      { id: 'select_one-randomize', type: 'select_one', label: 'Randomized', icon: 'CircleDot', defaultAppearance: 'randomize', description: 'Randomizes the order of choices each time' },
      ...
      { id: 'select_one_from_file-horizontal', type: 'select_one_from_file', label: 'CSV Horizontal', icon: 'FileSpreadsheet', defaultAppearance: 'horizontal', platform: 'field', description: 'CSV-sourced choices displayed horizontally' },
      { id: 'select_one_from_file-compact', type: 'select_one_from_file', label: 'CSV Compact', icon: 'FileSpreadsheet', defaultAppearance: 'compact', platform: 'field', description: 'CSV-sourced choices in compact layout' },
      { id: 'select_one_from_file-horizontal-compact', type: 'select_one_from_file', label: 'CSV Horiz Compact', icon: 'FileSpreadsheet', defaultAppearance: 'horizontal-compact', platform: 'field', description: 'CSV-sourced choices in horizontal compact layout' },
      ...
      { id: 'select_multiple_from_file-horizontal', type: 'select_multiple_from_file', label: 'CSV Multi Horiz', icon: 'FileSpreadsheet', defaultAppearance: 'horizontal', platform: 'field', description: 'CSV multi-select displayed horizontally' },
      { id: 'select_multiple_from_file-compact', type: 'select_multiple_from_file', label: 'CSV Multi Compact', icon: 'FileSpreadsheet', defaultAppearance: 'compact', platform: 'field', description: 'CSV multi-select in compact layout' },
      { id: 'select_multiple_from_file-horizontal-compact', type: 'select_multiple_from_file', label: 'CSV Multi H-Comp', icon: 'FileSpreadsheet', defaultAppearance: 'horizontal-compact', platform: 'field', description: 'CSV multi-select in horizontal compact layout' },
      ...
      { id: 'select_multiple-horizontal-compact', type: 'select_multiple', label: 'Multi Horiz Compact', icon: 'CheckSquare', defaultAppearance: 'horizontal-compact', description: 'Same as compact for multi-select questions' },
      { id: 'select_multiple-randomize', type: 'select_multiple', label: 'Multi Randomized', icon: 'CheckSquare', defaultAppearance: 'randomize', description: 'Multi-select with randomized choice order' },
      ...
      { id: 'rank-horizontal-compact', type: 'rank', label: 'Rank Horiz Compact', icon: 'ArrowUpDown', defaultAppearance: 'horizontal-compact', platform: 'field', description: 'Horizontal compact ranking layout' },
